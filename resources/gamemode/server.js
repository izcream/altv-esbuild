...
// src/gamemode/server/index.ts
import { emitClient } from "alt-server";

// src/future-rp/server/decorators/event.decorator.ts
import { on, onClient } from "alt-server";
...
var ServerClass = class {
  ...
  handlePlayerConnectClient(player) {
...
__decorateClass([
  On("playerConnect")
], ServerClass.prototype, "handlePlayerConnect", 1);
__decorateClass([
  OnClient("clientInit")
], ServerClass.prototype, "handlePlayerConnectClient", 1);
new ServerClass();
/*! *****************************************************************************
